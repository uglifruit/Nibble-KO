...
char const *string_desc_arr[] = {
	...
	// The browser finds the card by matching this string — see web/index.html's
	// device filter. Changing it means changing that regex too.
	"NIBBLE-KO (Workshop)",  // 2: Product
